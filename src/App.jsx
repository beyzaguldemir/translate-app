...
function App() {
  ...
  */
  ...
  const handleSwap=()=>{
    //* select alanlarındaki evrileri yer değistirir
  ...
  return (
    <div className="bg-zinc-900 h-screen text-white grid place-items-center">
      <div className='w-[80vw] max-w-[1100px] flex flex-col justify-center'>
        ...
        <button onClick={handleSwap} className='text-white bg-zinc-700 px-6 py-2 rounded hover:ring-2 hover:bg-zinc-800'>Değiş</button>
        ...
        <div className='flex mt-5 gap-3 md:gap-[105px] max-md:flex-col'>
          ...
          <div className='flex-1 relative'>
            <textarea value={translateState.answer} disabled className='w-full min-h-[300px] max-h-[500px] text-gray-200 p-[10px] text-[20px] rounded'></textarea>
            {
        ...
        <button onClick={handleTranslate} className='bg-zinc-700 mt-3 py-3 px-5 text-[17px] rounded hover:ring-2 hover:bg-zinc-900 transition'>Çevir</button>
      </div>
    </div>
  )
}
